...
export default class Bot {
    ...
    draw(){
        ...
        for(let i = 0; i < this.hand.length-this.gp.anmBotHand; i++){
            ...
            this.gp.screen.drawImage(this.gp.assetm.getCard("otherside"), x, 60, this.gp.assetm.cardDimensions.w, this.gp.assetm.cardDimensions.h);
            // this.gp.screen.drawImage(this.gp.assetm.getCard(this.hand[i].color+this.hand[i].number), x, 60, this.gp.assetm.cardDimensions.w, this.gp.assetm.cardDimensions.h);
        }
